...
export const Register = () => {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 w-full h-96 bg-gradient-to-b from-emerald-100/50 to-transparent"></div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-600 px-4">
          Get instant ATS analysis, resume scoring, and AI-powered suggestions.
        </p>
      </div>
      ...
      >
        <div className="bg-white py-8 px-4 shadow-xl shadow-slate-200/50 sm:rounded-2xl sm:px-10 border border-slate-100">
          ...
          <div className="space-y-3 mb-8">
            <button className="w-full inline-flex justify-center items-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl shadow-sm bg-white text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  autoComplete="name"
                  required
                  className="appearance-none block w-full px-3 py-2.5 border border-slate-300 rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
                />
              </div>
            </div>
      ...
      {/* Trust Badge */}
      <div className="mt-10 text-center text-sm text-slate-500 font-medium relative z-10">
